...
return [
    ...
    'providers' => [
        ...
        'openrouter' => [
            ...
            'models' => [
                'text' => [
                    'default' => env('AI_EMPLOYEE_MODEL', env('OPENROUTER_MODEL', 'openai/gpt-4o-mini')),
                    'cheapest' => env('AI_EMPLOYEE_CHEAP_MODEL', 'openai/gpt-4o-mini'),
                    'smartest' => env('AI_EMPLOYEE_SMART_MODEL', 'openai/gpt-4o'),
                ],
            ],
        ],
